...
#include <memory>
#include "../../../SerialPortDemo/cpp/common/AppInfo.h"
...
QT_MOC_LITERAL(3, 22, 5) // "title"
    ...
    "AppInfo\0titleChanged\0\0title"
};
...
void AppInfo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AppInfo::titleChanged)) {
                *result = 0;
                return;
            }
        }
