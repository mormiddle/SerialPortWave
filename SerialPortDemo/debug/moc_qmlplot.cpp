...
QT_MOC_LITERAL(4, 40, 18), // "pluralValueChanged"
QT_MOC_LITERAL(5, 59, 13), // "setAisleValue"
QT_MOC_LITERAL(6, 73, 14), // "setPluralValue"
QT_MOC_LITERAL(7, 88, 14), // "initCustomPlot"
QT_MOC_LITERAL(8, 103, 11), // "upAisleData"
QT_MOC_LITERAL(9, 115, 8), // "saveData"
QT_MOC_LITERAL(10, 124, 9), // "clearData"
QT_MOC_LITERAL(11, 134, 9) // "clearPlot"

    },
    "CustomPlotItem\0aisleValueChanged\0\0"
    "value\0pluralValueChanged\0setAisleValue\0"
    "setPluralValue\0initCustomPlot\0upAisleData\0"
    "saveData\0clearData\0clearPlot"
};
#undef QT_MOC_LITERAL
...
void CustomPlotItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->pluralValueChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->setAisleValue((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 3: _t->setPluralValue((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 4: _t->initCustomPlot(); break;
        case 5: _t->upAisleData(); break;
        case 6: _t->saveData(); break;
        case 7: _t->clearData(); break;
        case 8: _t->clearPlot(); break;
        default: ;
        }
        ...
        {
            using _t = void (CustomPlotItem::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CustomPlotItem::pluralValueChanged)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void CustomPlotItem::pluralValueChanged(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
